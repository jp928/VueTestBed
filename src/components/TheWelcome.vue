...
import { default as WelcomeItemDefault } from "./WelcomeItem.vue";
...
import TheHOC from "./TheHOC";
import AnotherHOC from "./AnotherHOC/AnotherHOC.vue";

const WelcomeItem = withConfig(WelcomeItemDefault, { test: "test" });
console.log("====>>, type", WelcomeItem.type);
const next = "hello";
...
<template>
  <AnotherHOC @change="onChange" />
  <TheHOC :first="'1'" />
  <WelcomeItem :next="next">
    <template #icon>
      <DocumentationIcon />
    </template>
